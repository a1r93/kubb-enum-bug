...
const require_package = require("./package-DWbfQn3K.cjs");
...
async function run(argv = process.argv) {
	...
	const [{ command: generateCommand }, { command: validateCommand }, { command: mcpCommand }, { command: agentCommand }, { command: initCommand }] = await Promise.all([
		Promise.resolve().then(() => require("./generate-B8yWJkXv.cjs")),
		Promise.resolve().then(() => require("./validate-FW87FvSa.cjs")),
		Promise.resolve().then(() => require("./mcp-BTDbLmo2.cjs")),
		Promise.resolve().then(() => require("./agent-C8XyzIYS.cjs")),
		Promise.resolve().then(() => require("./init-BiZ-h1_J.cjs"))
	]);
	await cli.run([
		generateCommand,
		validateCommand,
