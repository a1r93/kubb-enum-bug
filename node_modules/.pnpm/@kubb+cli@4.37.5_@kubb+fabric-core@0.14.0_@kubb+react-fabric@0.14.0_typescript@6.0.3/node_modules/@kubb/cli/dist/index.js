...
import { t as version } from "./package-DM-i6G84.js";
...
async function run(argv = process.argv) {
	...
	const [{ command: generateCommand }, { command: validateCommand }, { command: mcpCommand }, { command: agentCommand }, { command: initCommand }] = await Promise.all([
		import("./generate-2W0n01OS.js"),
		import("./validate-DizOSWTJ.js"),
		import("./mcp-zeTBZGck.js"),
		import("./agent-BcIeE93u.js"),
		import("./init-70wSkNFm.js")
	]);
	await cli.run([
		generateCommand,
		validateCommand,
